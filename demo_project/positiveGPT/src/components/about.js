            ...
            <div className="about-window">
                <div className="about-content">
                    ...
                    <div className="about-text">
                        <h2 style={{ fontSize: '100px', margin: '50px' }}> &#9786;</h2>
                        <h2 style={{ textAlign: 'left' }}>What is positive reframing?</h2>
                        ...
                        <h2 style={{ textAlign: 'left' }}>We draw on six main strategies...</h2>
                        ...
                        <h2 style={{ textAlign: 'left' }}>Want to learn more?</h2>
                        <p style={{ textAlign: 'left' }}>Check out       <a href="https://aclanthology.org/2022.acl-long.257/">the paper that inspired this tool.</a>
                        </p>
